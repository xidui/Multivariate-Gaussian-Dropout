...
if __name__ == '__main__':
    run(dataset='MNIST', apply_layer='conv', rate=0.1, type='multivariant2')
    run(dataset='MNIST', apply_layer='fc', rate=0.1, type='multivariant2')
    run(dataset='MNIST', apply_layer='conv', rate=0.1, type='gaussian2')
    # run(dataset='MNIST', apply_layer='fc', rate=0.1, type='gaussian2')
    # run(dataset='MNIST', apply_layer='conv', rate=0.1, type='multinomial2')
    # run(dataset='MNIST', apply_layer='fc', rate=0.1, type='multinomial2')

    run(dataset='CIFAR10', apply_layer='conv', rate=0.1, type='multivariant2')
    run(dataset='CIFAR10', apply_layer='fc', rate=0.1, type='multivariant2')
    run(dataset='CIFAR10', apply_layer='conv', rate=0.1, type='gaussian2')
    # run(dataset='CIFAR10', apply_layer='fc', rate=0.1, type='gaussian2')
    # run(dataset='CIFAR10', apply_layer='conv', rate=0.1, type='multinomial2')
    # run(dataset='CIFAR10', apply_layer='fc', rate=0.1, type='multinomial2')
